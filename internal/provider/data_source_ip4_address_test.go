...
func TestAccIP4AddressDataSource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				Config: testAccIP4AddressDataSourceConfig,
...
const testAccIP4AddressDataSourceConfig = testAccEntityDataSourceConfig + `
